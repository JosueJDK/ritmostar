...
// Reset password
Route::post('/password-reset', [FrontendController::class, 'showResetForm'])->name('pass.reset');
// Socialite
...
// Cursos
Route::get('/course-grids', [CourseController::class, 'courseGrids'])->name('course-grids');
Route::get('/course-lists', [CourseController::class, 'courseLists'])->name('course-lists');
Route::match(['get','post'],'/course/filter', [CourseController::class, 'courseFilter'])->name('shop.course.filter');
