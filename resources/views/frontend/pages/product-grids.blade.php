...
@section('title','RITMOSTAR || PRODUCT PAGE')
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="price">
													@if($product->discount > 0)
														<del class="text-muted">S/ {{ number_format($product->price,2)}}</del>
													@else
														<br>
													@endif
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    ...
                                                    <div class="product-action-2">
                                                        <a title="Añadir al carro" href="{{route('add-to-cart',$product->slug)}}">Añadir al carro</a>
                                                    </div>
                                                </div>
                                            </div>
