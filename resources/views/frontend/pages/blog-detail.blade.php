                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                Debe <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Iniciar sesión</a> O <a style="color:blue " href="{{route('register.form')}}">Registrarse</a> para comentar.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Blog Categorias</h3>
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Boletin informativo</h3>
