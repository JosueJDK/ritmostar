...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label for="address" class="col-form-label">Direccion <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">Numero Telefono <span class="text-danger">*</span></label>
